        ...
        <nav className="w-[360px]">
          <ul className="bg-white p-7  h-full  shadow-2xl ">
           {/* <span> <img src={logoImg} className="h-20 inline" /> </span> */}
            <h3 className=" font-extrabold text-4xl inline-block ml-3 text-blue-700 relative top-2">ZE</h3>
            <h3 className=" font-extrabold text-4xl inline-block text-red-600 relative top-2">RO</h3>
            ...
            <span>{user.lastName}</span>
              ...
              <li className=" font-small text-lg m-4 mt-0 ">
              {user.email}
            </li>
              </>
             )}
            ...
            <Link to={"/contributers"}  >
              <li className="  font-small  text-lg mb-8 m-0 mt-1 hover:bg-[#e6effc] pt-[14px] pb-[14px] pl-[15px] rounded-md"
                      id="class1"
            ...
            <Link to={"/tasks"}>
              <li className=" font-small text-lg mb-8  mt-1  hover:bg-[#e6effc] pt-[14px] pb-[14px] pl-[15px] rounded-md"
                id="class2"
            ...
            <Link to={"#"} >
              ...
              <li className="  mb-8 font-small text-lg  mt-1  hover:bg-[#e6effc] pt-[14px] pb-[14px] pl-[15px] rounded-md"
              id="class3"
              //  onClick={(e)=> highlight(e,e.target.id)}
              >
            ...
            <Link to={"/barchart"}>
              <li className=" font-small text-lg mb-3 hover:bg-[#e6effc] pt-[14px] pb-[14px] pl-[15px]  rounded-md"
                id="class4"
                // onClick={(e)=> highlight(e,e.target.id)}
               >
            ...
            <Link to={"/piechart"}>
              <li className=" font-small text-lg mb-3 mt-1  hover:bg-[#e6effc] pt-[14px] pb-[14px] pl-[15px]  rounded-md"
                id="class5"
                // onClick={(e)=> highlight(e,e.target.id)}
                >
