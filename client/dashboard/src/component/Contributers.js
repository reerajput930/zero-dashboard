...
import { faFaceSmile, faMessage, searching } from "@fortawesome/free-regular-svg-icons";
         ...
         return(
          <div className="user--card bg-white shadow-md rounded-lg m-3 h-fit w-[26%]">
                  ...
                  <div className="img--block w-24 h-20 m-3 ml-5">
                      <img className="rounded-full w-24 h-24 object-cover" src={user.image? user.image: defaultImg} alt="profile image" />
                  </div>
                   <div className="detail--block flex flex-col justify-center ml-4 mr-8">
                      <h2 className="name text-lg font-bold" >{user.firstName} {user.lastName}</h2>
                  ...
                  <div className="btn--section border-t-4 border-[#fafbfb] flex justify-evenly">
                      <div className=" w-full text-center p-3 border-r-4 border-[#fafbfb] cursor-pointer hover:bg-[#0091D5] hover:text-white font-semibold rounded-bl-md"><FontAwesomeIcon className="mr-2" icon={faMessage} /> <a href={user.email} target="_blank" >Send Email</a></div>
                      <div className=" w-full text-center p-3 cursor-pointer hover:bg-[#0091D5] hover:text-white font-semibold rounded-br-md"><a href={user.linkedin} target="_blank" > <FontAwesomeIcon className="mr-2" icon={faFaceSmile} />View Profile</a> </div>
                  </div>
  ...
  if(loading){
      ...
      //  console.log(user)
       return(
        <div className="user--card bg-white shadow-md rounded-lg m-3 h-fit w-[26%]">
                ...
                <div className="btn--section border-t-4 border-[#fafbfb] flex justify-evenly">
                      <div className=" w-full text-center p-3 border-r-4 border-[#fafbfb] cursor-pointer hover:bg-[#0091D5] hover:text-white font-semibold rounded-bl-md"><FontAwesomeIcon className="mr-2" icon={faMessage} /> <a href={user.email} target="_blank" >Send Email</a></div>
                      <div className=" w-full text-center p-3 cursor-pointer hover:bg-[#0091D5] hover:text-white font-semibold rounded-br-md"><FontAwesomeIcon className="mr-2" icon={faFaceSmile} /><a href={user.linkedin} target="_blank" >View Profile</a> </div>
                  </div>
    ...
    return(
      <div className="flex flex-col  w-[-webkit-fill-available] items-center" >
        ...
        <input type="text" onChange={searching} id="search" className=" inline w-[60%]   h-14 outline-none mt-20 p-5 pt-[15px] rounded-xl shadow-lg"
