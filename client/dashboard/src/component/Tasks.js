...
export default function Tasks() {
    ...
    tasks[task.category].push(
      ...
      >
        ...
        <div className="btn--block">
          <button className="bg-[#0091D5] text-white font-medium hover:bg-[#1C4E80] " onClick={(e) => del(e, task._id)}>
        
            DELETE   </button>
            <Link to={"/update"} ><FontAwesomeIcon  className="mr-3" icon={faEdit} /></Link>
          {/* <button>edit</button> */}
        </div>
      </div>
    );
  ...
  return (
    <div className="taskmanger--block  ">
      <h1 className="heading  mt-12 font-extrabold text-4xl ">Task progress Report!</h1>
